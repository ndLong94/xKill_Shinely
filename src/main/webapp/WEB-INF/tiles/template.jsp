...
<%-- 	<script src="${pageContext.servletContext.contextPath }/resources/js/plugins/flot/excanvas.min.js"></script> --%>
<%-- 	<script src="${pageContext.servletContext.contextPath }/resources/js/plugins/flot-data.js"></script> --%>
<%-- 	<script src="${pageContext.servletContext.contextPath }/resources/js/plugins/flot/jquery.flot.js"></script> --%>
<%-- 	<script src="${pageContext.servletContext.contextPath }/resources/js/plugins/flot/jquery.flot.pie.js"></script> --%>
<%-- 	<script src="${pageContext.servletContext.contextPath }/resources/js/plugins/flot/jquery.flot.resize.js"></script> --%>
<%-- 	<script src="${pageContext.servletContext.contextPath }/resources/js/plugins/flot/jquery.flot.tooltip.min.js"></script> --%>
	
<%-- 	<script src="${pageContext.servletContext.contextPath }/resources/js/plugins/morris/morris.js"></script> --%>
...
<body>
    ...
    <div id="wrapper">
        ...
        <!-- Navigation -->
        <nav class="navbar navbar-inverse navbar-fixed-top"  style="background-color: #337ab7" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html" style="color: white;">OpenStack Dashboard</a>
                <ul class="nav navbar-nav side-nav" style="background-color: #f5f5f5; margin-left: 0px; color: white;" >
                    <li class="active">
                        <a href="index.html" style="color: #114070"><i class="fa fa-fw fa-dashboard" ></i> Dashboard</a>
                    </li>
                    <li>
                        <a href="charts.html" style="color: #114070"><i class="fa fa-fw fa-bar-chart-o"></i> Charts</a>
                    </li>
                    <li>
                        <a href="tables.html" style="color: #114070"><i class="fa fa-fw fa-table"></i> Tables</a>
                    </li>
                    <li>
                        <a href="forms.html" style="color: #114070"><i class="fa fa-fw fa-edit"></i> Forms</a>
                    </li>
                    <li>
                        <a href="bootstrap-elements.html" style="color: #114070"><i class="fa fa-fw fa-desktop"></i> Bootstrap Elements</a>
                    </li>
                    <li>
                        <a href="bootstrap-grid.html" style="color: #114070"><i class="fa fa-fw fa-wrench"></i> Bootstrap Grid</a>
                    </li>
                    <li>

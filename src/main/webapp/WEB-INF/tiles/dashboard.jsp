    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${pageContext.request.contextPath }/VMDetail.html" style="color: white;">OpenStack Dashboard</a>
            </div>
            <!-- Top Menu Items -->
            ...
            <ul class="nav navbar-right top-nav" style="background-color: #337ab7">
                <li class="dropdown">
                    <a style="color: white;"><i class="fa fa-user" style="background-color: #337ab7; color: white;" ></i> Hello!...</a>
                </li>
            </ul>
